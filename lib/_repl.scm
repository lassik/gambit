...
(define-prim (##show-help-for-procedure proc)
  (##show-help (if (##string? proc) proc
                   (##object->string (if (##procedure? proc)
                                         (##procedure-name proc)
                                         proc)))
               "fn"))

(define-prim (##default-help proc)
  (##show-help-for-procedure proc))
